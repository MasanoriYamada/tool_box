...
mlflow.set_experiment('bert2 training')  

# training code
with mlflow.start_run():
    logging = Logger(args, args.description, use_tensorboard=True, use_mlflow=True)
    logging.add_metric('train/loss', 1.0, step=0)
    logging.add_metric('train/loss', 0.01, step=1)
    logging.add_metric('train/loss', 0.001, step=2)
    results = {}
