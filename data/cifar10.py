...
class Loader():
    def __init__(self, batch_size, alpha=1.0, beta=0.0):
        ...
        self.label_num = [10]
        self.factor = ['number']
        self.label_name = ['plane', 'car', 'bird', 'cat',
        ...
        train_dataset = datasets.CIFAR10(train_path, train=True, download=True, transform=data_transform_train)
        test_dataset = datasets.CIFAR10(test_path, train=False, transform=data_transform_test)
