...
#-----------------------------
#  neeed pip install jupyter_contrib_nbextensions
import os
import shutil
...
def post_save(model, os_path, contents_manager):
    ...
    if name != 'Untitled':
        ...
        html_name = name + '.html'
        try:
            shutil.move(os.path.join(d,py_name), os.path.join(d, name, py_name))
            shutil.move(os.path.join(d,html_name), os.path.join(d, name, html_name))
        except:
            pass
